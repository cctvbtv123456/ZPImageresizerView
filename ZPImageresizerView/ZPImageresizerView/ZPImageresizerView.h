...
@interface ZPImageresizerView : UIView

/**
 * 层级结构
 - ZPImageresizerView（self）
 - scrollView
...
/** 遮罩样式，目前初始化后不可再更改 */
@property (nonatomic, readonly) ZPImageresizerMaskType maskType;

/** 边框样式 */
@property (nonatomic) ZPImageresizerFrameType frameType;
